...
def mixup_data(images_1, images_2):
...
def main():
    ...
    train_images_2 = train_images[random_list_range]
    train_labels_2 = train_labels[random_list_range]
    train_weights_2 = train_weights[random_list_range]
    ...
    for ep in range(args.epochs):
        ...
        for batch, (images, labels, weights, images_2, labels_2, weights_2) in enumerate(train_dataset):
            mix_images , lam = mixup_data(images, images_2)
            loss_value, grads = util.cal_grad_mixup(model,
